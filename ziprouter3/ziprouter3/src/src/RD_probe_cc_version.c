...
static
#endif
void cc_version_callback(BYTE txStatus, BYTE rxStatus,
...
static
#endif
void version_capabilities_callback(BYTE txStatus, BYTE rxStatus,
    ZW_APPLICATION_TX_BUFFER *pCmd, WORD cmdLength, void* user)
{
  rd_ep_database_entry_t *ep = (rd_ep_database_entry_t*) user;
  rd_node_database_entry_t* n = ep->node;;
...
static
#endif
void version_zwave_software_callback(BYTE txStatus, BYTE rxStatus,
    ZW_APPLICATION_TX_BUFFER *pCmd, WORD cmdLength, void* user)
{
  rd_ep_database_entry_t *ep = (rd_ep_database_entry_t*) user;
  rd_node_database_entry_t *n = ep->node;
