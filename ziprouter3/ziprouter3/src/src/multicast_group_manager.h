 ...
 *
 * If we run out of groups, re-use the oldest group.  I.e., the group
...
/**
 * Create or lookup a group id corresponding to a list of nodes represented as a bitmask.
 *
 ...
 * return its id.
 *
 * If there are no subsets, create a new group in the next unused
 * slot.
 *
 * If there are no more slots, find the least recently used group,
