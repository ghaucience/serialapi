...
uint8_t nvm_restore(uint32_t offset, uint8_t *buf, uint8_t length, uint8_t *length_written) {
   return 0;
}

uint8_t nvm_backup(uint32_t offset, uint8_t *buf, uint8_t length, uint8_t *length_read) {
   return 0;
}
