...
uint8_t val_sl_C[] = {0xc2, 0xa9, 0x20, 0x53, 0x69, 0x6c, 0x69, 0x63, 0x6f, 0x6e, 0x20, 0x4c, 0x61, 0x62, 0x73, 0x2e, 0x00};
struct pvs_tlv tlv_loc_sl = {NULL, PVS_TLV_TYPE_LOCATION, 17, val_sl_C};
